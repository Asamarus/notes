...
rison.decode = function (r) {
	...
	const p = new rison.parser(errcb);
	return p.parse(r);
};
...
(function (table) {
	for (let i = 0; i <= 9; i++) table[String(i)] = table['-'];
})(rison.parser.prototype.table);
